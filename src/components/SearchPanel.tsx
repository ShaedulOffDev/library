...
const SearchPanel = () => {
  ...
  const { searchingBy, sortingBy, category }: string | any = useSelector(
    ...
    <div className="flex flex-col items-center justify-center bg-[#1D1F21] py-[75px] cont">
      <form className="flex mb-4 w-full justify-center" onSubmit={setSearch}>
        <label className="w-[500px] max-[678px]:w-[100%] relative">
          <input
            ...
            className="w-full border text-white rounded p-3 outline-none bg-transparent placeholder:text-white text-[18px] max-[678px]:py-2 max-[678px]:text-[16px]"
            placeholder="Search..."
            type="text"
          />
      ...
      <div className="text-white flex justify-between w-[500px] max-[500px]:flex-col max-[500px]:w-full">
        <label>
          ...
          <select
            value={category}
            className="max-[500px]:w-full max-[500px]:mt-1 px-3 max-[678px]:py-1 py-2 bg-transparent border rounded outline-none"
        ...
        <label className="max-[500px]:mt-3">
          ...
          <select
            value={sortingBy}
            className="max-[500px]:w-full max-[500px]:mt-1 max-[678px]:py-1 px-3 py-2 bg-transparent border rounded outline-none"
